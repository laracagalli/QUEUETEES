...
public final class QueueStatusPanel extends JPanel {
    public QueueStatusPanel() {
        ...
        Ui.addLeft(this, Ui.label("QUEUE", 10, Font.BOLD, Ui.FOREST));
        add(Box.createVerticalStrut(4));
        Ui.addLeft(this, Ui.label("Queue status", 25, Font.BOLD, Ui.INK));
        add(Box.createVerticalStrut(5));
        Ui.addLeft(this, Ui.label("See the order being served and those waiting next.", 11, Font.PLAIN, Ui.MUTED));
